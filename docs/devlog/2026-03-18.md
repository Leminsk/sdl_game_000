...
![Host was on a Windows 10 machine](/docs/assets/images/2026-03-18/a.png)  

Now let's look at the newly joined player's perspective:  
![Client was on a Linux Mint machine](/docs/assets/images/2026-03-18/b.png)  
...
![It's the same machine, but the principle is the same](/docs/assets/images/2026-03-18/bare_bones_multiplayer.gif)