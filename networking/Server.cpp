...
void Server::OnClientDisconnect(std::shared_ptr<olc::net::connection<MessageTypes>> client) {
    this->clients_amount--;
...
void Server::OnMessage(std::shared_ptr<olc::net::connection<MessageTypes>> client, olc::net::message<MessageTypes>& msg) {
