...
// UI colors
const SDL_Color COLORS_UI_BUTTON_BACKGROUND_1 = { 0x14, 0x14, 0x64, SDL_ALPHA_OPAQUE };
const SDL_Color COLORS_UI_BUTTON_BORDER_1 = { 0xE6, 0xD2, 0xBE, SDL_ALPHA_OPAQUE };